...
PVM.prototype.multiply = function(mat, vector){
	var newPos;
	mat4.multiplyVec3(mat, [vector.getX(), vector.getY(), vector.getZ()], newPos);
	vector.setX(newPos[0]);
	vector.setY(newPos[1]);
	vector.setZ(newPos[2]);
};

PVM.prototype.getMVMatrix = function(){
	return this.mvMatrix;
};

PVM.prototype.getPMatrix = function(){
	return this.pMatrix;
};